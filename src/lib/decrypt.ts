...
export const convertToLatin = (dataInBytes: Uint8Array<ArrayBuffer>) => {
...
export const convertToEmoji = (dataInBytes: Uint8Array<ArrayBuffer>) => {
	const dataArray = Array.from(new Uint8Array(dataInBytes));
...
export const emojiToBytes = (data: string[]) => {
